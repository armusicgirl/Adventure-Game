            ...
            do
            {
                ...
                if (commandWords.Length == 1 )
                {
                        ...
                        commandWords[0] == "UP" || commandWords[0] == "Down")
                    {
                        ...
                        if (commandWords[0] == "N" || commandWords[0] == "NORTH" && rooms[currentRoom].ToNorth != 0)
                        {
                            currentRoom = rooms[currentRoom].ToNorth;
                            Console.WriteLine();
                        }
                        else if (commandWords[0] == "E" || commandWords[0] == "EAST" && rooms[currentRoom].ToEast != 0)
                        {
                            currentRoom = rooms[currentRoom].ToEast;
                            Console.WriteLine();

                        }
                        else if (commandWords[0] == "S" || commandWords[0] == "SOUTH" && rooms[currentRoom].ToSouth != 0)
                        {
                            currentRoom = rooms[currentRoom].ToSouth;
                            Console.WriteLine();

                        }
                        else if (commandWords[0] == "W" || commandWords[0] == "WEST" && rooms[currentRoom].ToWest != 0)
                        {
                            currentRoom = rooms[currentRoom].ToWest;
                            Console.WriteLine();

                        }
                        else if (commandWords[0] == "U" || commandWords[0] == "UP" && rooms[currentRoom].ToUp != 0)
                        {
                            currentRoom = rooms[currentRoom].ToUp;
                            Console.WriteLine();

                        }
                        else if (commandWords[0] == "D" || commandWords[0] == "Down" && rooms[currentRoom].ToDown != 0)
                        {
                ...
                else if (commandWords.Length == 2)
                {
                    if (commandWords[0] == "GET")
                    {
                        if (rooms[currentRoom].roomItem.Find(item => item.ItemName == commandWords[1]) != null)
                        {
                            ...
                            rooms[currentRoom].roomItem.RemoveAt(rooms[currentRoom].roomItem.FindIndex(item => item.ItemName == commandWords[1]));
